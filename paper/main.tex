...
\hypersetup{
  ...
  pdftitle={Matchgate Commutator Graphs as Rectangular Minuscule Lattices: Brownian-Bridge Distances, Graph Complexity, and a Krylov Bound},
...
limit.  A stars-and-bars word identifies a uniform $k$-subset of $[N]$ with a uniform
...
Thus the action is transitive on the Pauli basis
...
\href{https://github.com/skypher/matchgate/tree/paper-2026-09-01-r5}%
{\texttt{paper-2026-09-01-r5}}.  It is built and run, for example, with
\begin{gather*}
