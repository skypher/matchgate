...
\hypersetup{
  ...
  pdftitle={Matchgate Commutator Graphs as Rectangular Minuscule Lattices: Brownian-Bridge Distances and Complexity},
...
$\alpha>0$ fixed.  Put $\ell_n=2n-k_n$.  If
$k_n/(2n)\to\rho$, then $\ell_n\sim2(1-\rho)n$ and
$\alpha=\rho/(1-\rho)$.  Consequently their $\ell_n^{3/2}$-normalized limit
has, in the present $n^{3/2}$ normalization, coefficient
\[
...
Conjecture~14.  The present finite-population proof treats the triangular-array
extension in which the two rectangle dimensions may vary arbitrarily subject
only to
...
archived at Git tag
\href{https://github.com/skypher/matchgate/tree/paper-2026-09-01-r3}%
{\texttt{paper-2026-09-01-r3}}.  It is built and run, for example, with
\begin{gather*}
