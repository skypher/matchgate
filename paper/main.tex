...
sequence $k_n/(2n)\to\rho\in(0,1)$, derive a joint vertex-and-Haar
graph-complexity asymptotic, and prove a separate pointwise graph--Krylov
comparison.  If $S$ and $T$ are independent uniform $k_n$-subsets of
$[2n]$, write
...
$\sqrt{2\pi}/4$, resolving Conjecture~14 of
...
on the symmetric-difference size.  The Krylov comparison is for
generator-supported time-independent Hamiltonians; no Haar-averaged Krylov
asymptotic is asserted.
...
Pauli representative of the first support to that of the second up to a phase
of modulus one.  Thus the action is transitive on the Pauli basis
$\mathcal C_k$.  This transitivity is the only
...
archived at Git tag
\href{https://github.com/skypher/matchgate/tree/paper-2026-09-01-r4}%
{\texttt{paper-2026-09-01-r4}}.  It is built and run, for example, with
\begin{gather*}
