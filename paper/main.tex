...
al. after the matchgate--minuscule-lattice identification.  Convergence of the
first two moments also gives
\[
...
that graph complexity is a pointwise lower bound for Krylov complexity under
every time-independent Hamiltonian in the real span of the matchgate
generators.
...
Haar statement is a joint expectation over an independent uniform initial
Pauli vertex and Haar matchgate unitary; it is not a pointwise-in-vertex
scaling statement.
...
used here~\cite{VallenderAddendum}.  Expected one-dimensional earth mover
distance
...
the statement recorded as Lemma~9 by West et al.~\cite{WestEtAl}.  Integrating
the pointwise inequality proves the expectation statement.
\end{proof}

\begin{remark}[Relation to Lemma~9 of West et al.]
The passage from Eq.~(A81) to Eq.~(A82) in the appendix proof of Lemma~9 in
West et al. does not follow from the stated support condition alone.  The
summands there contain cross terms in Lanczos coefficients and Pauli
...
inequality.  Equations~\eqref{eq:graph-tail-projections} and
...
comparison.  The preceding proof therefore establishes the cited inequality
without the cross-term step.
\end{remark}
...
& limiting constant\\
\hline
$1/4$  & 100 & 50  & 0.539679867710 & 0.542700940919\\
$1/4$  & 800 & 400 & 0.542319852915 & 0.542700940919\\
$1/10$ & 100 & 20  & 0.369966929897 & 0.375994241195\\
$1/10$ & 800 & 160 & 0.375223283732 & 0.375994241195
\end{tabular}
...
\end{table}
The values in both tables are deterministic floating-point evaluations of
finite sums, not Monte Carlo estimates or certified interval bounds.
...
closed-form finite-size mean and its leading $n^{1/2}$ correction, while the
central
...
identified by the Git tag \texttt{paper-2026-09-01} at
\url{https://github.com/skypher/matchgate/tree/paper-2026-09-01}.  It is
...
distributions on the line},
Theory of Probability and Its Applications \textbf{26} (1982), 435.
